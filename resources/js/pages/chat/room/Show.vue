    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="relative flex h-screen w-full flex-col">
            ...
            <div i class="h-screen w-full">
                ...
                <!-- Page Footer -->
                <footer class="fixed bottom-0 items-center border-t border-slate-200/75 bg-white lg:start-80">
                    <form class="container mx-auto flex h-20 items-center gap-2 px-4 lg:px-8 xl:max-w-7xl" onsubmit="return false;">
                        <input
                            type="text"
